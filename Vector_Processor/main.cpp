 ...
 * 
 * Trajectory Of Processor: main() ---> vectorProcessor() ---> dimensionSelect() ---> cartesian3D() ---> vectorprocessor() ---> ...
 ...
 * 
 * Programming Features Utilized: 1. Local Class (Selector) --> vectorProcessor(): line 1064
 *                                
 *                                2. Exception Handling --> dimensionSelect(): line 1109
 *                                                          coordinateSelect(): line 1139
 *                                                          operationSelect(): line 1178
 *                                
 *                                3. Recursion --> dimensionSelect(): line 1111
 *                                                 coordinateSelect(): line 1141
 *                                                 operationSelect(): line 1186
 *                                
 *                                4. Conditional Operator --> coordinateSelect(): line 1139
 *                                                            operationSelect(): line 1180
 *                                
 *                                5. Template Function (processorDriver2D(): line 82) --> cartesian2D(): line 1201, 1214
 *                                                                                        polar2D(): line 1229, 1242
 *                                
 *                                6. Template Function (processorDriver3D(): line 119) --> cartesian3D(): line 1258, 1285
 *                                                                                         sphericalPolar3D(): line 1301, 1328
 *                                                                                         cylindricalPolar3D(): line 1344, 1372
 *                                
 *                                7. Static Data Members --> Contains Unit Vectors & The Null Vectors (Type: String)
 *                                
 ...
 *                                
 *                                9. Operator Overloading --> Opeartor '+': Overloaded In All Vector Classes
...
class Vector3SP: public Vector3C {
	...
	protected:
		...
		double magnitude(); // Function magnitude() Of Vector3SC Redefined In Vector3SP
		double zenith() final; // Function zenith() Of Vector3SC Redefined In Vector3SP; Cannot Be Redefined In Subsequent Derived Classes
...
class Vector3CP: public Vector3SP, private Root {
	...
	public:
		...
		Vector3CP operator+ (Vector3CP&); // Overloaded Operator Redefined; Vector3SP Also Contains Operator '+' Of Vector3C, Vector3SP As Member Function
		Vector3CP operator- (Vector3CP&); // Overloaded Operator Redefined; Vector3SP Also Contains Operator '-' Of Vector3C, Vector3SP As Member Function
...
string Vector2C::unit_x = "ẋ";
string Vector2C::unit_y = "ẏ";
string Vector2C::null_vector = "ȯ";
...
string Vector2P::unit_r = "ṙ";
string Vector2P::unit_az = "θ";

Vector2P::Vector2P() { radial = 0.f; azimuth = 0.f; } // Default Constructor Of Vector2C; Calls Default Constructor Of Vector2C
...
// Redefinition Of Barebone Virtual Function transformation() Of Vector2C, In Vector Vector2P
...
string Vector3C::unit_x = "ẋ";
string Vector3C::unit_y = "ẏ";
string Vector3C::unit_z = "ż";
string Vector3C::null_vector = "ȯ";
...
string Vector3C::getNullVector() { return null_vector; } // Static Member Function, Can Only Access Static Data Members Of Vector2C; Inherited By Vector3SP, Vector3CP
...
// Redefinition Of Barebone Virtual Function transformation() Of Vector3C, In Vector Vector3SP; Functions Accessed Are Members Of Vector3SP, Except displayVector()
...
// Definition Of Friend Function crossProduct() Of Vector3SP; Can Access Protected Members Of Vector3C Directly
...
string Vector3CP::unit_r = "ṙ";
string Vector3CP::unit_az = "θ";
string Vector3CP::unit_al = "ż";
...
// Parameterized Constructor Of Vector3CP Calls Parameterized Constructor Of Vector3SP --> Vector3C; sqrt() Of 'math.h' Utilized, Since sqrt() Of Root Is Not Initialized Yet
...
// Redefinition Of Virtual Function transformation() Of Vector3C, In Vector Vector3CP
...
// Redefinition Of Barebone Virtual Function transformation() Of Vector3C, In Vector Vector3CP; Functions Accessed Are Members Of Vector3SP, Except displayVector()
...
// Definition Of Function crossProduct() Of Friend Class CrossVector; Friend OF Vector3CP; Can Access Protected Members Of Vector3CP Directly
